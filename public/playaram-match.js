...
function normalizeChampionName(value) { return String(value || "").toLocaleLowerCase("ja").replace(/[^a-z0-9]/g, ""); }
function championInfo(name) { const key = normalizeChampionName(name); return champions.find((champion) => normalizeChampionName(champion.id) === key || normalizeChampionName(champion.name) === key) || null; }
